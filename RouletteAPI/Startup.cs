...
using Roulette.Infraestructure.Repositories;
...
namespace RouletteAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var redisDB = ConnectionMultiplexer.Connect(Configuration.GetValue<string>("RedisConnection"));
            services.AddSingleton(x => redisDB.GetDatabase());
        }
